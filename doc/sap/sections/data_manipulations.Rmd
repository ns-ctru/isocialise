...
**INPUT REQUIRED** - be useful to have greater detail on what sounds like a subset of responses are to be used.
...
**INPUT REQUIRED** - above is copied from the protocol, seems incomplete "[SOMETHING?] is a friendship subscale...".
