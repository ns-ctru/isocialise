...
**NB** The Trial Steering Committee (TSC) has advised/requested that a Per-Protocol analyses be performed  as well.  The last Trial Management Group (TMG) meeting 2017-10-25 it was agreed that to meet the protocol participants had to complete 50% of the threapy sessions.  The protocol (`r study$protocol_version`) needs updating to reflect this.
