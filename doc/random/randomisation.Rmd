...
## Results - Cohort {.tabset .tabset-fade .tabset-pills}
```{r child = 'sections/results_cohort.Rmd', eval = TRUE}
```

## Results - RCT {.tabset .tabset-fade .tabset-pills}
```{r child = 'sections/results_rct.Rmd', eval = FALSE}
```
